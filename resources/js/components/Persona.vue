                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="persona in arrayPersona" :key="persona.id">
                                    ...
                                    <td v-text="persona.identifiacion"></td>
                                    <td v-text="persona.casado"></td>
                                    <td v-text="persona.ingresos"></td>
                                    <td v-text="persona.vehhiculoactual"></td>
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idvehiculo">
                                            ...
                                            <option v-for="vehiculo in arrayVehiculo" :key="vehiculo.id" :value="vehiculo.id" v-text="vehiculo.placa"></option>
                                        </select>                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" v-model="identifiacion" class="form-control" placeholder="">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Casado</label>
                                    <div class="col-md-9">
                                        <select v-model="casado" class="form-control">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Ingresos mensuales</label>
                                    <div class="col-md-9">
                                        <input type="number" v-model="ingresos" class="form-control" placeholder="">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">Vehículo Actual</label>
                                    <div class="col-md-9">
                                        <input type="email" v-model="vehhiculoactual" class="form-control" placeholder="Vehículo Actual">
                                    </div>
                                </div>
                    ...
                    case "persona":
                    {
                        switch(accion){
                            ...
                            case 'actualizar':
                            {
                                ...
                                this.identifiacion=data['identifiacion'];
                                this.casado=data['casado'];
                                this.ingresos= data['ingresos'];
                                this.vehhiculoactual= data['vehhiculoactual'];
                                break;
                            }
                        }
                    }
